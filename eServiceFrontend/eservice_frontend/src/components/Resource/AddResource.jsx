...
const AddResource = () => {
  ...
  const handleVerificationChange = () => {
    setVerificationChecked(!verificationChecked);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (allFieldsEmpty || !verificationChecked) {
      alert("Cannot submit form. At least one field should be filled, and verification must be checked.");
      return;
    }
        ...
        <div className="formConatiner">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-check" style={{ marginTop: "20px" }}>
              ...
              />
              <label className="form-check-label" htmlFor="verificationCheckbox" style={{ color: "white" }}>
